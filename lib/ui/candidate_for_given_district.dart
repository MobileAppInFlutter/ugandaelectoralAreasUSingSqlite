...
class CandidateForAgivenDistrict extends StatefulWidget {
  @override
  _CandidateForAgivenDistrictState createState() => _CandidateForAgivenDistrictState();
}

class _CandidateForAgivenDistrictState extends State<CandidateForAgivenDistrict> {
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  Text('Other Name:'),
                                  Text('${_searchResult[index].otherName}'),
                                ],
                              ),
                              Row(
                                children: [
